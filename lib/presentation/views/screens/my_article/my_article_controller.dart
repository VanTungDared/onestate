...
class MyArticleController extends GetxController {
  MyArticleController(this.getListingMeUseCase);
  final GetListingMeUseCase getListingMeUseCase;
  ...
  void fetchListings() async {
    ...
    final result = await getListingMeUseCase.call(1, pageSize, "sell");
  ...
  void fetchMoreListings() async {
    ...
    final result = await getListingMeUseCase.call(nextPage, pageSize, "sell");
    result.fold(
      (error) {
