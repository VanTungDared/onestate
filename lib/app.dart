  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: const SystemUiOverlayStyle(
        statusBarColor: Colors.white, // màu status bar cố định
        statusBarIconBrightness: Brightness.light, // icon sáng / tối
        systemNavigationBarColor: Colors.white, // màu navigation bar (Android)
      ),
